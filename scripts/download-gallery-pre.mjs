// Download galleries for the new pre-order run into public/figures/<key>/. Gentle.
...
writeFileSync(join(__dirname, "gallery-manifest-pre.json"), JSON.stringify(manifest, null, 2));
console.log("\nWrote scripts/gallery-manifest-pre.json");
await browser.close();
